-- AI-Powered Watchlist System Schema
-- This extends the existing tokens schema with watchlist functionality
...
DROP POLICY IF EXISTS "Public read access to public watchlists" ON watchlists;
DROP POLICY IF EXISTS "Service role full access" ON watchlists;
DROP POLICY IF EXISTS "Public read access to public watchlist tokens" ON watchlist_tokens;
DROP POLICY IF EXISTS "Service role full access to watchlist tokens" ON watchlist_tokens;
DROP POLICY IF EXISTS "Service role full access to ai analysis" ON ai_analysis;
DROP POLICY IF EXISTS "Service role full access to premium subscriptions" ON premium_subscriptions;
DROP POLICY IF EXISTS "Service role full access to ai config" ON ai_watchlist_config;
